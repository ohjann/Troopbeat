...
class User extends Media {
	...
	public static function getArtistTracks($user,$artist,$limit = null){
		$xml = CallerFactory::getDefaultCaller()->call('user.getArtistTracks', array(
			'user' => $user,
			'artist' => $artist,
			'limit' => $limit
		));
	 ...
	 * @throws	Error
	 */
	public static function getTopArtists($user, $period = null, $limit = null){
